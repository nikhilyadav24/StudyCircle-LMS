    ...
    return (
        <nav className={`z-[10] flex h-14 w-full items-center justify-center border-b-[1px] border-b-richblack-700 text-white translate-y-0 transition-all ${showNavbar} `}>
            ...
            <div className='flex w-11/12 max-w-maxContent items-center justify-between '>
                {/* logo */}
                <Link to="/">
                    <img src={studyCircleLogo} width={160} height={42} loading='lazy' />
                </Link>
                            ...
                            <li key={index}>
                                {
                                    link.title === "Courses" ? (
                                        <div
                                            className={`group relative flex cursor-pointer items-center gap-1 ${matchRoute("/courses") || matchRoute("/catalog/:catalogName")
                                                ...
                                                {loading ? (<p className="text-center ">Loading...</p>)
                                                    : (
                                                        <>
                                                            ...
                                                            <Link
                                                                to="/courses"
                                                                className="rounded-lg bg-transparent py-4 pl-4 hover:bg-richblack-50 font-semibold border-b border-richblack-100"
                                                            >
                                                                <p>All Courses</p>
                                                            </Link>
