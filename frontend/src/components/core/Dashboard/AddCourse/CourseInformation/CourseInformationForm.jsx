...
export default function CourseInformationForm() {
  ...
  const onSubmit = async (data) => {
    ...
    formData.append("courseName", data.courseTitle)
    formData.append("courseDescription", data.courseShortDesc)
    formData.append("price", data.coursePrice || 0) // Default to 0 for free courses
    formData.append("tag", JSON.stringify(data.courseTags))
    formData.append("whatYouWillLearn", data.courseBenefits)
    formData.append("category", data.courseCategory)
    ...
    >
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="coursePrice">
          Course Price <span className="text-yellow-25">(Optional - Courses are FREE)</span>
        </label>
        ...
        <p className="text-xs text-yellow-25">All courses are free for students</p>
      </div>
