...
exports.getCategoryPageDetails = async (req, res) => {
    try {
        console.log('=== GET CATEGORY PAGE DETAILS ===');
        const { categoryId } = req.body
        ...
        console.log('Courses in category:', selectedCategory?.courses?.length || 0);
        ...
        // Handle the case when there are no courses - return empty data instead of 404
        ...
        console.log("Most selling courses:", mostSellingCourses.length);
        ...
        console.error('=== GET CATEGORY PAGE DETAILS ERROR ===');
